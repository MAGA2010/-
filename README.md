...
| 留学中介 (新东方/启德) | Excel + PDF | **五大指标图层切换**，点一下切换数据维度 |
...
| # | 指标 | 配色 | 含义 | 数据来源 |
|---|------|------|------|----------|
| 1 | **收入水平** | 🟢 绿渐变 | 越深=区域越富裕 | Census ACS 5-Year |
| 2 | **安全系数** | 🔵 蓝 → 🔴 红 | 蓝=安全，红=高犯罪率 | FBI UCR |
| 3 | **就业指数** | 🟦 蓝绿渐变 | 越深=就业率越高（基于 BLS 失业率） | BLS / LinkedIn / 高校就业报告 |
| 4 | **留学成本** | 🟠 橙渐变 | 越深=年度留学成本越高（学费+生活费） | College Board / 大学财务公开 |
| 5 | **华人水平** | 🟡→🔴 黄红 | 越深=华人占比越高 | Census ACS API |

历史版本曾使用「托福成绩 / SAT 分数 / 录取率」组合，2026-07 中旬已替换为「就业指数 / 留学成本」。
